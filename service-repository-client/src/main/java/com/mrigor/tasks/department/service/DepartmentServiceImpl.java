...
public class DepartmentServiceImpl implements DepartmentService {
    ...
    public void update(Department department) throws NotFoundException {
        ...
        Assert.notNull(department, "department must not be null");
        Department update = departmentDao.update(department);
        ExceptionUtil.checkNotFoundWithId(update != null, department.getId().intValue());
    }
    ...
    public Department get(int id) throws NotFoundException {
        ...
        return ExceptionUtil.checkNotFoundWithId(departmentDao.get(id), id);
    }
