...
public class EmployeeTestData {
    ...
    public static final ModelMatcher<Employee> MATCHER_LIGHT = ModelMatcher.of(Employee.class,
            (expected, actual) -> expected == actual || Objects.equals(expected.getId(), actual.getId())
                    && Objects.equals(expected.getBirthDay(), actual.getBirthDay())
                    && Objects.equals(expected.getFullName(), actual.getFullName())
                    && Objects.equals(expected.getSalary(), actual.getSalary())
    );
    ...
    public static final Department DEP1 = new Department(100000, "Marketing", null);
    public static final Department DEP2 = new Department(100001, "Production", null);
    ...
    public static final Employee EMPL1_WITHOUT_DEP = new Employee(EMPL1_ID, "Ivanov Ivan", of(1980, 5, 17), 400, null);
    public static final Employee EMPL2_WITHOUT_DEP = new Employee(EMPL2_ID, "Petrov Petr", of(1992, 12, 31), 250, null);
    public static final Employee EMPL3_WITHOUT_DEP = new Employee(EMPL3_ID, "Sidorov Anton", of(1992, 11, 5), 210, null);
    ...
    public static final List<Employee> EMPL_D1_WITHOUT_DEP = Arrays.asList(EMPL1_WITHOUT_DEP, EMPL2_WITHOUT_DEP, EMPL3_WITHOUT_DEP);
    ...
    public static Employee getUpdated() {
        return new Employee(EMPL1_ID, "Update employee", EMPL1.getBirthDay(), 300, null);
    }
